...
Run time: 2026-08-10 22:23:37 UTC
...
|-------:|:---------|:-----------------------|-------------:|:------------------------|--------------:|---------------:|-----------------:|----------------------:|:-----------------------------------------|:--------------|:---------------|:------------------------|
|      1 | ARF.AX   | ARENA REIT             |         2.56 | A$1,040,986,304         |        -21.95 |         -19.5  |           -21.71 |                 17.97 | 1D <= -7.0%; 5D <= -12.0%; 20D <= -20.0% |               |                | not_run                 |
...
|      4 | TVN.AX   | TIVAN LTD              |         0.25 | A$569,862,848           |         -2    |          -2    |           -25.76 |                  1.07 | 20D <= -20.0%                            | trading halt  |                | not_run                 |
...
|   rank | ticker   | company                |   last_price | market_cap_aud_approx   |   one_day_pct |   five_day_pct |   twenty_day_pct |   volume_spike_vs_20d | trigger                  | avoid_flags   | openai_score   | openai_classification   |
|-------:|:---------|:-----------------------|-------------:|:------------------------|--------------:|---------------:|-----------------:|----------------------:|:-------------------------|:--------------|:---------------|:------------------------|
|      1 | WBC.AX   | WESTPAC BANKING CORP   |        35.7  | A$121,912,197,120       |         -5.88 |          -6.47 |            -3.25 |                  2.19 | 1D <= -4.0%              |               |                | not_run                 |
|      2 | CDA.AX   | CODAN LTD              |        39.12 | A$7,114,962,432         |         -4.72 |          -2.4  |            -7.41 |                  1.52 | 1D <= -4.0%              |               |                | not_run                 |
|      3 | BPT.AX   | BEACH ENERGY LTD       |         0.82 |                         |         -4.62 |          -8.84 |            -5.71 |                  1.96 | 1D <= -4.0%; 5D <= -8.0% |               |                | not_run                 |
|      4 | CNI.AX   | CENTURIA CAPITAL GROUP |         1.49 |                         |          0.68 |           1.71 |           -16.06 |                  0.45 | 20D <= -15.0%            |               |                | not_run                 |
